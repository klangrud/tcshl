...
function setup_player_stats() {
    ...
    $playerStatsResult = mysql_query($playerStatsSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function setup_goalie_stats() {
    ...
    $goalieStatsResult = mysql_query($goalieStatsSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
