...
function setup_teams_this_season() {
    ...
    $teamsThisSeasonResult = mysql_query($teamsThisSeasonSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function setup_sponsor_select() {
    ...
    $sponsorCandidatesResult = mysql_query($sponsorCandidatesSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
