...
function get_player_name($pId) {
    ...
    $pResult = mysql_query($pSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function get_skill($skillNum) {
    ...
    $skillResult = mysql_query($skillSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    $skillName = '';
...
function get_current_game_type() {
    ...
    $gameTypeResult = mysql_query($gameTypeSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
