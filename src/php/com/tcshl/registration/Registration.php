	...
	private $usaHockeyMembership;
 	...
 	function formPreLoad($smarty) {
		...
		*/
		...
		if($this->get_jerseySize() == 'L')
			$smarty->assign('jsl','CHECKED');
		if($this->get_jerseySize() == 'XL')
			$smarty->assign('jsxl','CHECKED');
		if($this->get_jerseySize() == 'XXL')
			$smarty->assign('jsxxl','CHECKED');
		if($this->get_jerseySize() == 'GOALIE')
		...
		if($this->get_drilLeague() == 1) 		
	    	$smarty->assign('dl1','CHECKED');
	    else if($this->get_drilLeague() == 2)
			$smarty->assign('dl2','CHECKED');
		else if($this->get_drilLeague() == 3)
			$smarty->assign('dl3','CHECKED');
		else
			$smarty->assign('dl1','CHECKED');
		if($this->get_payToday() == 1) 		
