 ...
 */
 ...
 class DateFormat {
 	...
 	public function formatTimestamp($unixTimestamp,$formatType) {
 		...
 		if($formatType=='MOBILE_DATE_FORMAT')
 		  $this->format_MobileDate();
 		else if($formatType=='MOBILE_TIME_FORMAT')
 		  $this->format_MobileTime();
 		else if($formatType=='SITE_DATE_FORMAT')
 		  $this->format_SiteDate();
 		else if($formatType=='SITE_TIME_FORMAT')
 		  $this->format_SiteTime();
