...
function set_game_current_status() {
    ...
    $statusResult = mysql_query($statusQuery, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function get_addresses() {
    ...
    $addressResult = mysql_query($addressSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function set_game_postponed() {
    ...
    $gameResult = mysql_query($gameUpdate, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
}
/*
 * Reschedule Game
*/
function set_game_reschedule() {
    ...
    $addGameUpdateResult = mysql_query($addGameUpdate, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
}
/*
...
function set_announcement($announceSubject = "", $announceBody = "") {
    ...
    $announceStatusResult = mysql_query($announceStatusSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    ...
    $setAnnounceResult = mysql_query($setAnnounceSelect, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    ...
    if ($setAnnounceResult) {
        ...
        $setAnnounceIdResult = mysql_query($setAnnounceIdSQL, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    }
    ...
    if ($latestGameAnnouncementID > 0) {
        ...
        $oldAnnounceDeleteResult = mysql_query($oldAnnounceDelete, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    }
}
/*
 * Send email
