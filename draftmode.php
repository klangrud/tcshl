...
} else if ((isset($_GET)) && ((isset($_GET['deletepick'])) && (($_GET['deletepick']) == 'true')) && ((isset($_GET['seasonId'])) && (($_GET['seasonId']) > 0)) && ((isset($_GET['playerId'])) && (($_GET['playerId']) > 0)) && ((isset($_GET['round'])) && (($_GET['round']) > 0)) && ((isset($_GET['teamId'])) && (($_GET['teamId']) > 0))) {
...
function process_draftmode_form() {
    ...
    $draftInsertResult = mysql_query($draftInsert, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    return $errors;
}
function delete_draft_pick($delSeasonId = '', $delPlayerId = '', $delRound = '', $delTeamId = '') {
    ...
    mysql_query($draftDelete, $Link) or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
    return $errors;
}
?>
