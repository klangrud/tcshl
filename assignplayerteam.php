...
function this_season_has_teams() {
	...
	$teamsThisSeasonExistResult = mysql_query($teamsThisSeasonExistSQL, $Link)
...
function set_player_info() {
	...
	$jerseyResult = 	mysql_query($jerseySelect, $Link)
	  or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function setup_jersey_warning_info() {
	...
	$jerseyWarningResult = 	mysql_query($jerseyWarningSelect, $Link)
	  or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());	
...
function setup_team_already_on() {
	...
	$teamsAlreadyOnResult = mysql_query($teamAlreadyOnSelect, $Link)
		or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
...
function process_assignplayerteam_form() {
  ...
  global $Link;	
	...
	mysql_query($assignPlayerInsert, $Link)
	  or die("sp_clubs (Line " . __LINE__ . "): " . mysql_errno() . ": " . mysql_error());
